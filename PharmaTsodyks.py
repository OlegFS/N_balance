...
J =[2500.]#400.,450.,450.,450.,600.]#[3822.]#[392.,427.,540.,854.,1709.,3822.]#[ 450., 450., 450.,450.]#[400.,450.,450.,450.,600.]#[400.,400.,400.,400.,400.]
eta =0.8#0.5
d =  [3.5]
NI_ =[990]#,200,500,800,990]#[40,200,800,3200,16000]#[50,200,500,800,950,990]#[200,500,800,950]#[200,800,2000,3200,3800]
U = 0.035
...
for bic in [1,0.5,0.2,0.01]:#[0.8,0.5,0.2]: 
    for i,NI in enumerate(NI_):
        ...
        A = DeprSynapses(directory= directory,
                                    ...
                                    chunk_size= 50000,
                                    voltage = False)
        A.build(U,tauSyn = 3.,constant_k=[0.1,0.1])#rate = 180.)#196
